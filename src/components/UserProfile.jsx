...
const UserProfile = () => {
  return (
    <Box sx={{ maxWidth: 800, margin: 'auto', padding: 3, mt: 14 }}>
      {/* Профиль картасы */}
      <Card
        sx={{ borderRadius: 3, boxShadow: 3, padding: 3, textAlign: 'center' }}
      >
        <Avatar
      ...
      <Card sx={{ mt: 3, borderRadius: 3, boxShadow: 2 }}>
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
            1. Paris Getaway - 12th April 2025
          </Typography>
          <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
            2. Bali Adventure - 5th May 2025
          </Typography>
          <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
            3. Tokyo Culture Tour - 20th June 2025
          </Typography>
        </CardContent>
      </Card>
    </Box>
